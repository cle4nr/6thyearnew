...
# ref.set(allfighters,countdiv,stancesall) #the analytics for each weight class, aka all data that will be displayed on website e.g. amount of fighters per weight class, average height of weight classes etc
